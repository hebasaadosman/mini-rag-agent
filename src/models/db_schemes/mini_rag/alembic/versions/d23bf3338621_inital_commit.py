...
Revision ID: d23bf3338621
Revises: 
Create Date: 2026-07-21 14:56:20.417834
...
def upgrade() -> None:
    ...
    op.create_index('uq_asset_name_project_id', 'assets', ['asset_name', 'asset_project_id'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index('uq_asset_name_project_id', table_name='assets')
